...
TVI_ROOT = HTREEITEM(-65536)  #HTREEITEM(ULONG_MAX-0x10000) -65536 0xffffffffffff0000
TVI_FIRST = HTREEITEM(-0x0FFFF)
TVI_LAST = HTREEITEM(-0x0FFFE)
TVI_SORT = HTREEITEM(-0x0FFFD)
# print("ULONG_MAX-0x10000 ", TVI_ROOT)
