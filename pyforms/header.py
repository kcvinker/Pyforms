...
from pyforms.enums import ControlType, TextAlignment, HeaderStyle
from pyforms.events import EventArgs, HeaderEventArgs
from pyforms.apis import SUBCLASSPROC, LPNMCUSTOMDRAW, LPRECT, LPWINDOWPOS
...
hdrDict = {}
# hdrStyle = con.HDS_BUTTONS | con.HDS_HORZ #| con.WS_BORDER
...
class Header(Control):
    ...
    def __init__(self, parent, xpos: int = 10, ypos: int = 10, 
        ...
        self._style |= con.HDS_BUTTONS | con.HDS_HORZ
