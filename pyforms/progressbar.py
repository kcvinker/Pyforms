...
from pyforms.enums import ControlType, ProgressBarStyle, ProgressBarState
...
pgbDict = {}
# pgbStyle = con.PBS_SMOOTH | con.WS_OVERLAPPED
...
class ProgressBar(Control):
    ...
    def __init__(self, parent, xpos: int = 10, ypos: int = 10,
        ...
        self._style |= con.PBS_SMOOTH | con.WS_OVERLAPPED 
