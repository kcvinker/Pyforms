...
from pyforms.enums import ControlType, NodeOp
import pyforms.apis as api
from pyforms.apis import LRESULT, HTREEITEM, LPNMHDR, LPNMCUSTOMDRAW, SUBCLASSPROC
from pyforms.colors import Color
# from horology import Timing
# from .winmsgs import log_msg

tvDict = {}
tvStyle = con.TVS_HASLINES|con.TVS_HASBUTTONS|con.TVS_LINESATROOT|con.TVS_DISABLEDRAGDROP|con.WS_BORDER
...
class TreeView(Control):
    ...
    def _makeTVItem(self, node) -> api.TVITEMEXW:
        ...
        Control._smBuffer.fillBuffer(node._text)
        tvi = api.TVITEMEXW()
        tvi.mask = con.TVIF_TEXT | con.TVIF_PARAM
        tvi.pszText = cast(Control._smBuffer.addr, c_wchar_p)
