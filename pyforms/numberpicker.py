...
from pyforms.enums import ControlType, TextAlignment
from pyforms.events import GEA
import pyforms.apis as api
from pyforms.apis import LRESULT, UINT_PTR, DWORD_PTR, WPARAM, LPARAM, SUBCLASSPROC
from pyforms.colors import Color, clamp
# from .winmsgs import log_msg

numpDict = {}
npTbDict = {}
numpStyle = con.UDS_ALIGNRIGHT|con.UDS_ARROWKEYS|con.UDS_AUTOBUDDY|con.UDS_HOTTRACK
